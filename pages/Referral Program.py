...
def referral():
    ...
    st.write(f"Your friends get {FRIEND_REFERRAL_CREDITS} extra Credits. Summing {INIT_CREDIT} + {FRIEND_REFERRAL_CREDITS} = {int(INIT_CREDIT)+int(FRIEND_REFERRAL_CREDITS)} Credits")
